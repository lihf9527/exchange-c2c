...
public class CreatePayModeForm {
    ...
    //    @EnumValue(message = "{c2c.payMode.accountType.EnumValue.message}", enumClass = AccountTypeEnum.class)
    ...
    @NotEmpty(message = "开户银行不能为空", groups = GroupBank.class)
